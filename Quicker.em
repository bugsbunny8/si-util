/****************************************************
 * Source Insight Quick Command Macros
 *
 ****************************************************/
...
macro InsertFileHeaderCN(hbuf, ln,szName,szContent)
{
    ...
    InsBufLine(hbuf, ln + 6,  "  ²ú Æ· Ãû   : Celon")
    InsBufLine(hbuf, ln + 7,  "  Ä£ ¿é Ãû   : ")
    InsBufLine(hbuf, ln + 8,  "  ×÷    Õß   : @szName@")
    SysTime = GetSysTime(1)
    szTime = SysTime.Date
    InsBufLine(hbuf, ln + 9,  "  Éú³ÉÈÕÆÚ   : @szTime@")
    iLen = strlen (szContent)
    nlnDesc = ln
    szTmp = "  ¹¦ÄÜÃèÊö   : "
...
macro FuncHeadCommentCN(hbuf, ln, szFunc, szMyName,newFunc)
{
    ...
    InsBufLine(hbuf, ln+5, " ×¢ÒâÊÂÏî  : ")
    InsbufLIne(hbuf, ln+6, " ");
    InsBufLine(hbuf, ln+7, " ÐÞ¸ÄÀúÊ·      :")
    SysTime = GetSysTime(1);
    szTime = SysTime.Date

    InsBufLine(hbuf, ln+8, "  1.ÈÕ    ÆÚ   : @szTime@")

    if( strlen(szMyName)>0 )
    {
       InsBufLine(hbuf, ln+9, "    ×÷    Õß   : @szMyName@")
    }
    else
    {
       InsBufLine(hbuf, ln+9, "    ×÷    Õß   : #")
    }
    InsBufLine(hbuf, ln+10, "    ÐÞ¸ÄÄÚÈÝ   : ÐÂÉú³Éº¯Êý")    
    InsBufLine(hbuf, ln+11, "")    
